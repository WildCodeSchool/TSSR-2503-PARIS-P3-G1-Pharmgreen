...
### 8.9 Sauvegarde automatique vers le serveur FTP 
...
### 8.9.2 - Creation du script : veeam_ftp_upload.ps1 dans C:\Scripts\
...
### 8.9.4 - Créer une tache pour automatiser l'envoie des sauvegardes vers le serveur FTP   
